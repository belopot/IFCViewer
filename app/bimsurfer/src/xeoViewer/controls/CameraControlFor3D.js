define(["../../../lib/xeogl"], function () {
    ...
    xeogl.CameraControlFor3D = xeogl.Component.extend({
        ...
        _initEvents: function () {
            ...
            (function () {
                ...
                function getDisCamWithTarget() {
                    var dis = distanceVec3(camera.eye, camera.look);
                    return dis;
                }
                ...
                (function () {
                    ...
                    canvas.addEventListener("wheel", function (e) {
                        ...
                        vZoom = -d * getDisCamWithTarget() * mouseZoomRate * 0.05;
                        e.preventDefault();
                    });
            ...
            self.on("cameraview", function (type) {
                ...
                switch (type) {
                    ...
                    case "right": // Right
                        ...
                        cameraTarget.look.set([0, cameraTarget.eye[1], cameraTarget.eye[2]]);
                    ...
                    case "back": // Back
                        ...
                        cameraTarget.look.set([cameraTarget.eye[0], 0, cameraTarget.eye[2]]);
                        cameraTarget.up.set(camera.worldUp);
                    ...
                    case "top": // Top
                        ...
                        cameraTarget.look.set([cameraTarget.eye[0], cameraTarget.eye[1], 0]);
                    ...
                    case "perspective": // Perspective view
                        camera.projection = "perspective";
                        break;

                    case "ortho": // Ortho view
