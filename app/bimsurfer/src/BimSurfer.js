...
define(["./Notifier", "./BimServerModel", "./PreloadQuery", "./BimServerGeometryLoader", "./xeoViewer/xeoViewer", "./EventHandler"], function (Notifier, Model, PreloadQuery, GeometryLoader, xeoViewer, EventHandler, _BimServerApi) {
    ...
    function BimSurfer(cfg) {
        ...
        this.onConnectCorner = function () {
            viewer.onConnectCorner();
        };
        this.onSquareMarker = function () {
            viewer.onSquareMarker();
        };
        this.onRotateEntity = function () {
            viewer.onRotateEntity();
        };
        ...
        this.settingViewerFor2DPlan = function(){
            viewer.settingViewerFor2DPlan();
        };

        this.settingViewerFor3DPlan = function(){
            viewer.settingViewerFor3DPlan();
        };
